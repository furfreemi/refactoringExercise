        ...
        for (j = 0; j < 10; j++) {
            for (l = 0; l < 6; l++) {
                ...
                if (marksByAxisByPlayerForChecking[playerMark] == 4
                        && marksByAxisByPlayerForChecking[TicTacToe.EMPTY] == 1) {
                    if (type == TicTacToe.SAFE_MODE) {
                        flag2 = TicTacToe.EMPTY;
                        for (k = 0; k < 5; k++) {
                            if (gameBoard[x][j * 10 + l + k] == TicTacToe.EMPTY
                                    && tempTableForChecks[j * 10 + l + k] == TicTacToe.OCCUPIED) {
                                flag2 = TicTacToe.OCCUPIED;
                            }
                        }
                        if (flag2 == TicTacToe.EMPTY) {
                            zbir++;
                            flag = TicTacToe.OCCUPIED;
                            break;
                        }
                    } else {
                        zbir++;
            ...
            for (l = 0; l < 6; l++) {
                ...
                if (marksByAxisByPlayerForChecking[playerMark] == 4
                    ...
                    if (type == TicTacToe.SAFE_MODE) {
                        flag2 = TicTacToe.EMPTY;
                        for (k = 0; k < 5; k++)
                            if (gameBoard[x][l * 10 + j + k * 10] == TicTacToe.EMPTY
                                    && tempTableForChecks[l * 10 + j + k * 10] == TicTacToe.OCCUPIED)
                                flag2 = TicTacToe.OCCUPIED;
                        if (flag2 == TicTacToe.EMPTY) {
                            zbir++;
                            flag = TicTacToe.OCCUPIED;
            ...
            for (j = 0; j < 6; j++) {
                ...
                if (marksByAxisByPlayerForChecking[playerMark] == 4
                    ...
                    if (type == TicTacToe.SAFE_MODE) {
                        flag2 = TicTacToe.EMPTY;
                        for (k = 0; k < 5; k++) {
                            if (gameBoard[x][l * 10 + j + k * 11] == TicTacToe.EMPTY
                                    && tempTableForChecks[l * 10 + j + k * 11] == TicTacToe.OCCUPIED) {
                                flag2 = TicTacToe.OCCUPIED;
                            }
                        }
                        if (flag2 == TicTacToe.EMPTY) {
            ...
            for (j = 0; j < 6; j++) {
                ...
                if (marksByAxisByPlayerForChecking[playerMark] == 4
                    ...
                    if (type == TicTacToe.SAFE_MODE) {
                        flag2 = TicTacToe.EMPTY;
                        for (k = 0; k < 5; k++) {
                            if (gameBoard[x][l * 10 + j - k * 9 + 40] == TicTacToe.EMPTY
                                    && tempTableForChecks[l * 10 + j - k * 9
                                    + 40] == TicTacToe.OCCUPIED) {
                                flag2 = TicTacToe.OCCUPIED;
                            }
                        }
                        if (flag2 == TicTacToe.EMPTY) {
